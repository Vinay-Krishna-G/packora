                    ...
                    >
                        <div className="flex items-start justify-between gap-4">
                            ...
                            <button
                                ...
                                className={`
                                    rounded-lg border px-3 py-1.5 text-xs font-semibold uppercase tracking-wider shrink-0 transition
                                    ${copiedIndex === index
                        ...
                        <div className="mt-3 max-h-[120px] overflow-auto rounded-lg border border-zinc-900 bg-zinc-950 p-3 text-xs text-zinc-400 font-mono whitespace-pre-wrap leading-relaxed select-all">
                            {prompt.prompt}
                        </div>
                    </div>
                ))}
