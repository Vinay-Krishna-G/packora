                ...
                <div className="rounded-2xl border border-border bg-card p-8 sm:p-10 shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-6 transition duration-150">
                    <div className="max-w-xl">
                        ...
                        <p className="mt-2.5 text-[13px] text-muted-foreground leading-relaxed font-sans">
                            CodeMelt is engineered entirely with client-side JavaScript. All directory file system traversal, technology and architecture analysis, and metadata summarization are compiled in your browser's local thread. We do not use remote servers, and we collect zero telemetry.
                        </p>
                    </div>
