import { ArchitectureType, DetectionResult, AIWorkflowPrompt } from "./types";
import { getOnboardingPrompt } from "./prompts/onboarding";
import { getRefactorPrompt } from "./prompts/refactor";
