...
import { PurposeResult, RepositoryPurpose } from "./types";
...
export function detectPurpose(
  ...
  const devDeps = ["commander", "yargs", "typescript", "eslint", "prettier", "tsup", "esbuild"];
  ...
  if (hasDirectory("scripts") || hasDirectory("bin") || hasFile("eslint.config.js")) {
